def ReadAndParseData(file_name):
    ...
    try:
        with open(file_name, 'r') as file:
            for line in file:
                ...
                if line.startswith('IQ ELLIPSE: '):
                    str_value = line[len('IQ ELLIPSE '):].strip().split(',')
                    try:
                        ...
                        print(f"Error parsing IQ ELLIPSE data in line: '{line}'. Error: {e}.")
                ...
                if line.startswith('IQ: '):
                    ...
                    try:
                        temp1 = float(str_value[0].strip())
                        temp2 = float(str_value[1].strip())
                        temp3 = float(str_value[2].strip())
    ...
    return I_ellipse, Q_ellipse, I_data, Q_data, temp1_data, temp2_data, temp3_data