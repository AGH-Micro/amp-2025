...
/**
  ...
  *            SYSCLK(Hz)                     = 64000000 (CPU Clock)
  *            HCLK(Hz)                       = 64000000 (AXI and AHBs Clock)
  *            AHB Prescaler                  = 1
  *            D1 APB3 Prescaler              = 1 (APB3 Clock  64MHz)
  *            D2 APB1 Prescaler              = 1 (APB1 Clock  64MHz)
  *            D2 APB2 Prescaler              = 1 (APB2 Clock  64MHz)
  *            D3 APB4 Prescaler              = 1 (APB4 Clock  64MHz)
